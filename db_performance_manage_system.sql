...
CREATE TABLE `biz_dept_scores` (
  ...
  `total_score` double DEFAULT NULL COMMENT '该月份总的',
  `last_edit_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='机构（部门）积分';

-- ----------------------------
-- Records of biz_dept_scores
-- ----------------------------
INSERT INTO `biz_dept_scores` VALUES ('1', '68', '1', '2018-02-01', '20', '50', null);
INSERT INTO `biz_dept_scores` VALUES ('2', '69', '2', '2018-03-01', '30', '60', null);
INSERT INTO `biz_dept_scores` VALUES ('3', '68', '2', '2018-02-01', '10', '10', null);
...
-- ----------------------------
INSERT INTO `biz_project` VALUES ('1', '1', '2134123', '测试项目', '这是备注', '0', '2018-03-01 13:48:03', null);
INSERT INTO `biz_project` VALUES ('3', '1', null, '测试项目2', '啊哈哈或或', '0', '2018-08-01 00:00:00', null);
...
-- ----------------------------
INSERT INTO `biz_project_type_scores` VALUES ('1', '1', '2018-02-01', '20', '50', null);
...
-- ----------------------------
INSERT INTO `biz_total_scores` VALUES ('1', '2018-02-01', '20', '500');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=447 DEFAULT CHARSET=utf8 COMMENT='菜单管理';
...
INSERT INTO `sys_menu` VALUES ('413', 'b1d703b2dd9245ab90a51015a4b074d6', '0905c7b221e04782b19f3090c162cf71', '编辑', null, null, 'role_edit', '2', null, null);
INSERT INTO `sys_menu` VALUES ('415', 'f572a336378e48dcb792ebee56790013', '0905c7b221e04782b19f3090c162cf71', '增加', null, null, 'role_add', '2', null, null);
INSERT INTO `sys_menu` VALUES ('416', 'be64ba4910b94047922f459ca1301ad6', '0905c7b221e04782b19f3090c162cf71', '资源授权', null, null, 'role_resource_auth', '2', null, null);
INSERT INTO `sys_menu` VALUES ('417', '17f665cba5cd4ac9b87d4b3ac20d1b9d', '0905c7b221e04782b19f3090c162cf71', '删除', null, null, 'role_del', '2', null, null);
