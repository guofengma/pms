...
/**
 * @Description: 规则配置公共常量
 * @author shenzhihao
 * @date 2018年3月6日 下午3:25:17
 */
public interface RuleConfigureConstant {
	...
	public enum PublishStatus {
		NO_PUBLISH(0, "没发布"), PUBLISHED(1, "已发布");
	...
	* @Description:  项目配置类型
	* @author shenzhihao 
	* @date 2018年3月20日 上午8:59:50 
	*/
	public enum ProjectConfigureType {
		BASE_CONF(1, "基础项目配置"), 
		OTHER_CONF(2, "其他项目配置");
		...
		private ProjectConfigureType(int value, String title) {
			this.value = value;
			this.title = title;
		}
